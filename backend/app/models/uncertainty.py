...
class MitigationAckRequest(BaseModel):
    ...
    mitigation_id: Optional[str] = Field(
        None,
        description="ID of the mitigation being applied (optional when provided in path)",
    )
    dimension: Optional[str] = Field(
        default=None,
        description="Optional dimension to reduce (technical/timeline/...)",
    )
...
class BayesianConfidenceRequest(BaseModel):
    ...
    phase: str = Field(
        ...,
        description="Development phase (ideation/design/mvp/implementation/testing)",
    )
